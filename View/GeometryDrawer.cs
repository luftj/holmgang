...
namespace holmgang.Desktop
{
    public static class GeometryDrawer
    {
        ...
        public static void init(GraphicsDevice graphicsDevice, SpriteBatch spriteBatch)
        {
            ...
            GeometryDrawer.graphicsDevice = graphicsDevice;
            GeometryDrawer.spriteBatch = spriteBatch;
        ...
        public static void fillRect(Vector2 pos, int width, int height, Color colour) { fillRect(new Rectangle((int)pos.X, (int)pos.Y, width, height), colour); }
        ...
        public static void drawLine(Vector2 A, Vector2 B, Color colour)
        {
            ...
            drawLineGradient(A, B, colour, colour);
        }

        public static void drawLineGradient(Vector2 A, Vector2 B, Color colourA, Color colourB)
        {
            // todo: implement line styles (thickness, ...)

            Vector3 a = new Vector3(A, 0);
            Vector3 b = new Vector3(B, 0);
            VertexPositionColor[] vertices = { new VertexPositionColor(a, colourA),
                                               new VertexPositionColor(b, colourB) };
